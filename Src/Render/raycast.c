...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/09/24 15:44:22 by andcarva          #+#    #+#             */
/*   Updated: 2025/09/24 15:44:24 by andcarva         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
+ (1 - ray->step_y) / 2) / ray->ray_dir_y;
	...
	ray->draw_start = (WIND_HEIGHT / 2) - (ray->line_height / 2);
	if (ray->draw_start < 0)
		ray->draw_start = 0;
	ray->draw_end = ray->line_height / 2 + (WIND_HEIGHT / 2);
